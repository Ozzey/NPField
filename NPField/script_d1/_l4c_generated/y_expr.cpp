...
L4CasADi l4casadi("/root_home/NPField/NPField/script_d1/_l4c_generated", "y_expr", true, "cuda", true, true, false);
...
static const casadi_int casadi_s_in0[3] = { 615, 1, 1};
