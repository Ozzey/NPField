...
L4CasADi l4casadi("/root_home/NPField/NPField/script_d3/_l4c_generated", "y_expr", true, "cuda", true, false, false);
...
static const casadi_int casadi_s_in0[3] = { 3459, 1, 1};
static const casadi_int casadi_s_out0[3] = { 10, 1, 1};


CASADI_SYMBOL_EXPORT int y_expr(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  l4casadi.forward(arg[0], 3459, 1, res[0]);
  return 0;
}

CASADI_SYMBOL_EXPORT int jac_y_expr(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  l4casadi.jac(arg[0], 3459, 1, res[0]);
  return 0;
}

CASADI_SYMBOL_EXPORT int jac_jac_y_expr(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  l4casadi.hess(arg[0], 3459, 1, res[0]);
  return 0;
}
